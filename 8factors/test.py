...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['volume','turnover','turnover_ratio']
...
from Tamplate import Psy,alpha159,alpha77,alpha170,alpha78,alpha18,TvStd20,rstr12

for f in ['Psy','alpha159','alpha77','alpha170','alpha78','alpha18','TvStd20','rstr12']:
